...
ActiveRecord::Schema.define(version: 20170727213012) do
  ...
  add_index "session_tokens", ["user_id", "session_token"], name: "index_session_tokens_on_user_id_and_session_token", using: :btree
